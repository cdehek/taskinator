...
var completeEditTask = function(taskName, taskType, taskId) {
    ...
    // loop through the array and task objects with new content
...
var deleteTask = function(taskId) {
    ...
    for (var i = 0; i < tasks.length; i++) {
        //if tasks[i].id doesnt math the vaule of taskId, lets keep that task and push it into the new array
        if (tasks[i].id !== parseInt(taskId)) {
